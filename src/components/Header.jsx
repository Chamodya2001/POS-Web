...
const Header = () => {
    ...
    return (
        <header className="h-16 glass-effect flex items-center justify-between px-4 md:px-8 fixed top-0 right-0 left-20 md:left-64 z-40 transition-all duration-300">
